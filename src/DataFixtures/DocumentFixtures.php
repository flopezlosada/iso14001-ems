...
final class DocumentFixtures extends AbstractGoldenFixture implements DependentFixtureInterface
{
    ...
    private function obligations(): array
    {
        return [
            ...
            ['code' => 'F.06.0', 'title' => 'DAFO', 'type' => DocumentType::FORM, 'chapter' => IsoChapter::CONTEXT, 'role' => 'direction', 'area' => Area::DAFO, 'status' => ObligationStatus::DONE, 'note' => 'Rev 01 (2025).', 'instructions' => 'Identifica Debilidades, Amenazas, Fortalezas y Oportunidades con enfoque ambiental. Cuanto más fiel sea a la entidad, mejor. Revisa y actualiza fecha y nº de revisión.'],
            ['code' => 'F.04.0', 'title' => 'Identificación y Evaluación de Partes Interesadas (PPI)', 'type' => DocumentType::FORM, 'chapter' => IsoChapter::CONTEXT, 'role' => 'direction', 'area' => Area::INTERESTED_PARTY, 'status' => ObligationStatus::DONE, 'note' => 'Hecho 2025.', 'instructions' => 'Identifica las partes interesadas (internas y externas) y sus necesidades y expectativas. Indica cualquier incidencia que se haya tenido con ellas.'],
            ...
            ['code' => 'F.0X.0', 'title' => 'RRHH', 'type' => DocumentType::RECORD, 'chapter' => IsoChapter::SUPPORT, 'role' => 'ems_manager', 'area' => null, 'status' => ObligationStatus::DONE, 'note' => 'Revisado Sept. 2025.', 'instructions' => 'Rellena los datos de la plantilla, las competencias y funciones por puesto y enlaza el organigrama. Revisa si ha habido cambios.'],
            ...
            ['code' => 'RG-08.01.01', 'title' => 'Control Operacional (interno)', 'type' => DocumentType::RECORD, 'chapter' => IsoChapter::OPERATION, 'role' => 'cleaning', 'area' => Area::OPERATIONAL_CONTROL, 'status' => ObligationStatus::DONE, 'note' => 'Revisada marzo 2026.', 'instructions' => 'Checklist mensual: marca con una X si cada ítem (consumos, instalaciones) se encuentra conforme o no conforme.'],
            ...
            ['code' => 'F.15.0', 'title' => 'Informe de Auditoría Interna', 'type' => DocumentType::FORM, 'chapter' => IsoChapter::PERFORMANCE_EVALUATION, 'role' => 'quality', 'area' => Area::SYSTEM_AUDIT, 'status' => ObligationStatus::IN_REVIEW, 'note' => 'Informe 2025 pendiente de completar.', 'instructions' => 'Tras la auditoría interna anual, redacta el informe con los hallazgos, las no conformidades detectadas y las conclusiones. Es la entrada del Plan de Acciones Correctivas.'],
